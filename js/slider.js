...
function showReviews(n) {
  let i;
  let reviews = document.getElementsByClassName("reviews__block");
  let toggles = document.getElementsByClassName("reviews__toggle");
  ...
  tabletMediaQuery.addEventListener('resize', function (evt) {
    // console.log(evt);
...
let buttonToggles = document.querySelectorAll('.reviews__toggle');
